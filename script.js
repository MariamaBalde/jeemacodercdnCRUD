class Jeemacoder extends React.Component {
    ...
    handleDelete(index) {
        const newCoder = this.state.coders.filter((code, i) => i !== index);
        this.setState({ coders: newCoder });
    }
        ...
        return <div className="py-4">
            ...
            <div className="container">
                <div style={{ maxWidth: 600, margin: "auto" }}>
                    ...
                    <button onClick={this.handleClick} className="btn btn-success w-100 mt-3">Submit</button>
                </div>
            </div>
